...
{
	public class TimeProblemSolver(ISolver solver, SolutionService solutionService, AbstractCollector collector, ResultsService<TxtLogger> resultsService, GridParameters gridParameters) : IProblemSolver
	{
